...
#define FORECOLOR_WATHET (FORECOLOR_BLUE | BRIGHTNESS)
...
#define BLUE (COLOR_MAGIC | FORECOLOR_BLUE | BACKCOLOR_BLACK)
#define WATHET (COLOR_MAGIC | FORECOLOR_WATHET | BACKCOLOR_BLACK)
